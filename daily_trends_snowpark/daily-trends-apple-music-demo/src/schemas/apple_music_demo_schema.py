from snowflake.snowpark.types import StructType, StructField, StringType, LongType, DateType, BooleanType, ArrayType, TimestampType, IntegerType
from common.src.schemas.scehmas import Schemas
from common.src.constants.category_definition import Categories
